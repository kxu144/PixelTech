...
public class EmitterContainer extends Container {
    ...
    public EmitterContainer(int windowID, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.EMITTER_CONTAINER.get(), windowID);
    ...
    public boolean stillValid(PlayerEntity playerIn) {
        return stillValid(IWorldPosCallable.create(tileEntity.getLevel(), tileEntity.getBlockPos()),
                playerIn, ModBlocks.EMITTER.get());
    }
