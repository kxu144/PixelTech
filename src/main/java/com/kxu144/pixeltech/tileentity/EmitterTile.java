...
public class EmitterTile extends TileEntity implements ITickableTileEntity, PokeConnectable {
    ...
    public boolean canSpawnLegend = false;
    public boolean canSpawnMythic = false;
    public boolean canSpawnUltra = false;
    ...
    public void load(BlockState state, CompoundNBT nbt) {
        ...
        this.canSpawnLegend = nbt.getBoolean("spawnLegend");
        this.canSpawnMythic = nbt.getBoolean("spawnMythic");
        this.canSpawnUltra = nbt.getBoolean("spawnUltra");
    ...
    public CompoundNBT save(CompoundNBT nbt) {
        ...
        nbt.putBoolean("spawnLegend", this.canSpawnLegend);
        nbt.putBoolean("spawnMythic", this.canSpawnMythic);
        nbt.putBoolean("spawnUltra", this.canSpawnUltra);
    ...
    private void doSpawning(boolean override) {
        if (this.tick == 0 || override) {
            ...
            boolean checkLegend = !this.canSpawnLegend && p.isLegendary();
            boolean checkMythic = !this.canSpawnMythic && p.isMythical();
            boolean checkUltra = !this.canSpawnUltra && p.isUltraBeast();
