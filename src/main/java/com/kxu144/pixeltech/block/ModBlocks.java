...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> POKEPIPE = registerBlock("pokepipe", () -> new PokePipeBlock(AbstractBlock.Properties.of(Material.GLASS).strength(3.0F).sound(SoundType.GLASS).noOcclusion()));
