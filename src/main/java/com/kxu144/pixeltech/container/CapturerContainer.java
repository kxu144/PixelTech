...
public class CapturerContainer extends Container {
    ...
    public CapturerContainer(int windowID, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.CAPTURER_CONTAINER.get(), windowID);
    ...
    public boolean stillValid(PlayerEntity playerIn) {
        return stillValid(IWorldPosCallable.create(tileEntity.getLevel(), tileEntity.getBlockPos()),
                playerIn, ModBlocks.CAPTURER.get());
    }
